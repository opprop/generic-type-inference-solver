...
public class PrintUtils {
    ...
    public static void printContradictingHardConstraints(final List<VecInt> hardClauses, final List<Constraint> hardConstraints,
                                                         final int numberOfNewVars, int numberOfClauses) {
        Xplain<ISolver> explanationSolver = new Xplain<>(SolverFactory.newDefault());
        configureExplanationSolver(numberOfNewVars, numberOfClauses, explanationSolver);
    ...
    protected static void configureExplanationSolver(int numberOfNewVars, int numberOfClauses, Xplain<ISolver> xplainer) {
    ...
    protected static void printAnalysisResult(List<Constraint> hardConstraints, Xplain<ISolver> xplainer) throws TimeoutException {
