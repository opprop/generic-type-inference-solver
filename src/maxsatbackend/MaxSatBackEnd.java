...
public class MaxSatBackEnd extends BackEnd<VecInt[], VecInt[]> {
    ...
    protected final List<Constraint> hardConstraints;
    ...
    public MaxSatBackEnd(Map<String, String> configuration, Collection<Slot> slots,
        ...
        this.hardConstraints = new LinkedList<>();
    ...
    public Map<Integer, AnnotationMirror> solve() {
        ...
        try {
            ...
            if (isSatisfiable) {
                ...
                PrintUtils.printContradictingHardConstraints(hardClauses, hardConstraints, numberOfNewVars, numberOfClauses);
            }
